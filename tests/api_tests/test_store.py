...
def test_add_order(existing_pet_id):
    ...
    request = store_wrapper.post_order(payload=payload)
...
def test_get_order(existing_pet_id):
    existing_order = store_wrapper.post_randomly_generated_order(existing_pet_id)
...
def test_add_order_for_0_pets(existing_pet_id):
    ...
    request = store_wrapper.post_order(payload=new_order)
...
def test_add_empty_order(existing_pet_id):
    request = store_wrapper.post_order(payload={})
...
def test_e2e_order_process():
    ...
    store_wrapper.post_order(order_payload)
